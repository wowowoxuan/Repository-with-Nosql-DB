...
namespace NoSqlDb
{
  ...
  public:
	...
	std::string& ischildren() { return ischildren_; }
	std::string ischildren() const { return ischildren_; }
	void ischildren(const std::string& name) { ischildren_ = name; }
  ...
  */
  ...
  {
    out << "\n  ";
    out << std::setw(25) << std::left << key.substr(0, 20);
