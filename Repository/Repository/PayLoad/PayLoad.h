...
namespace NoSqlDb
{
  ...
  */
  inline Sptr PayLoad::toXmlElement()
  {
	...
	Sptr sPtrfilename = XmlProcessing::makeTaggedElement("filename", filename_);
	sPtr->addChild(sPtrfilename);
	Sptr sPtrstatus = XmlProcessing::makeTaggedElement("status", status_);
	sPtr->addChild(sPtrstatus);
	Sptr sPtrauthor = XmlProcessing::makeTaggedElement("author", author_);
	sPtr->addChild(sPtrauthor);
  ...
  */
  ...
  inline void PayLoad::showPayLoadHeaders(std::ostream& out)
  {
	...
	out << std::setw(25) << std::left << "filename";
	out << std::setw(12) << std::left << "author";
	out << std::setw(12) << std::left << "status";
  ...
  inline void PayLoad::showElementPayLoad(NoSqlDb::DbElement<PayLoad>& elem, std::ostream& out)
  {
	...
	out << std::setw(25) << std::left << elem.payLoad().filename().substr(0,22);
	out << std::setw(12) << std::left << elem.payLoad().author().substr(0, 22);
	out << std::setw(12) << std::left << elem.payLoad().status().substr(0, 22);
